...
<!-- ==================== AREA CHEF ==================== -->
			<div class="area-chef">
				<div class="photo-perfil">
					<?php if($dados['foto']){ ?>
						<div class="img foto_menu" style="background: url(<?= APP_URI_APP ?>public/upload_perfil/<?= $dados['foto'] ?>) no-repeat center center; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;" id="output"></div>
					<?php } else { ?>
						<div class="img" style="background: url(<?= APP_URI_APP ?>public/images/no_foto_thumb.png) no-repeat center center; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;" id="output"></div>
					<?php } ?>
				</div>
				<div class="infos">
					...
					if(count($lista) > 0){
						foreach($lista as $keyp => $valuesp){ 
							...
							<div class="prato">
								...
								<div class="clear"></div>
								<span class="imagem-prato"><a href="<?= APP_URI_APP ?>pag-prato-off/<?= $valuesp['prato_id'] ?>"><img src="<?= APP_URI_APP ?>public/upload_fotos/<?= $valuesp['foto'] ?>" /></a></span>
						...
						<div class="erroPerfil">
							...
							<div class="erro-dir">
								<p class="erro-tit">Infelizmente este perfil não possui nenhum prato. Faça uma nova <a href="<?= APP_URI_APP ?>"><b>busca</b></a> para achar o que deseja.</p>
																
								<p class="erro-txt" style="margin-top: 70px;">Links úteis que podem te ajudar:</p>
								<ul>
