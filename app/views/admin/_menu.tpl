...
<?php if(!$_SESSION['user_id']){ ?>
	<!-- ======================= HEADER NÃO LOGADO ======================= -->
		...
		<header class="interna">
			...
			<a href="<?= APP_URI_APP ?>" class="logo"><img src="<?= APP_URI_PUBLIC ?>images/logo-color-beta.svg" style="max-width:100%; height:auto;" /></a>
...
<?php } else { ?>    
	...
	<!-- ======================= HEADER LOGADO USER COMUM ======================= -->
		...
		<header class="interna" style="display:none;">
			...
			<a href="<?= APP_URI_APP ?>" class="logo l-simple"><img src="<?= APP_URI_PUBLIC ?>images/logo-simple-color-beta.svg" style="max-width:100%; height:auto;" /></a>
			<a href="#" class="show-menu-mobile">
				<span></span>
				<span></span>
				<span></span>
			...
			<div class="menu-header" id="nav">
				<?php if($flag_cpf != ''){ ?>
					<ul>
						...
						<li><a href="<?= APP_URI_APP ?>faq" class="ajuda-mobile">Ajuda</a></li>
				...
				<?php if($flag_cpf != ''){ ?>
					<ul>
						<li class="hover-sub">
							<p onclick="window.location.href='<?= APP_URI_APP ?>abertura';" class="name-user"><?= $perfil_nome ?></p>
							<?php if(!empty($perfil_foto)){ ?>
								<span class="photo-perfil"><div class="img foto_menu" style="background: url(<?= APP_URI_PUBLIC ?>upload_perfil/<?= $perfil_foto ?>) no-repeat center center; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;" id="output"></div></span>
							<?php } else { ?>
								<span class="photo-perfil"><div class="img" style="background: url(public/images/no_foto_thumb.png) no-repeat center center; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;" id="output"></div></span>
							<?php } ?>		
							<span class="sub-menu">
