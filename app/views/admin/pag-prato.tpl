				...
				<div class="infos-prato">
					...
					<div class="desc-prato">
						...
						<div class="area-ingredientes">
							...
							<?= $dados_prato['ingredientes'] ?>
						</div>
					</div>
					<div class="area-palavras-chave">
						<p class="sub">Palavras chaves:</p>
						<?php foreach($dados_prato_palavraschave as $keyp => $valuesp){ ?>
							<p class="keyword"><a href="<?= APP_URI_APP ?>pag-chef-busca/pchave/<?= utf8_decode($valuesp) ?>"><?= utf8_decode($valuesp) ?></a></p>
						<?php } ?>
						<div class="clear"></div>
					</div>
					<div class="area-categoria">
						...
						<?php foreach($dados_prato_categorias_nome as $keyp => $valuesc){ ?>
							<p class="keyword"><a href="<?= APP_URI_APP ?>pag-chef-busca/categoria/<?= $keyp ?>"><?= $valuesc ?></a></p>
						<?php } ?>
						<div class="clear"></div>
					</div>
			...
			<div class="pos">
				<div class="info-chef">
					<span class="photo-perfil">
						<?php if($dados['foto']){ ?>
							<img src="<?= APP_URI_APP ?>public/upload_perfil/<?= $dados['foto'] ?>" style="width: 50px; height: 50px;" />
						<?php } else { ?>
							<img src="<?= APP_URI_APP ?>public/images/no_foto_thumb.png" style="width: 50px; height: 50px;" />
						<?php } ?>
					</span>
					<div class="ver-mais">
		...
		<div class="area-pratos-relacionados">
			...
			<div class="prato">
				...
				<span class="imagem-prato">
					<img src="http://lorempixel.com/290/195/food/1" />
				</span>
				<div class="bt-share">
			...
			<div class="prato">
				...
				<div class="clear"></div>
				<span class="imagem-prato">
					<img src="http://lorempixel.com/290/195/food/2" />
				</span>
				<div class="bt-share">
					<a href="#" class="click-share"><i class="flaticon-network19"></i></a>
					<div class="share-prato">
			...
			<div class="prato">
				...
				<div class="clear"></div>
				<span class="imagem-prato">
					<img src="http://lorempixel.com/290/195/food/3" />
				</span>
				<div class="bt-share">
					<a href="#" class="click-share"><i class="flaticon-network19"></i></a>
					<div class="share-prato">
